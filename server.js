...
app.post('/heroku/sso', function handleSSO(req,res) {
  ...
  return res.redirect(`http://bluzellestudio.heroku.com?address=${app.get('bluzelleStudioAddress')}&port=${app.get('bluzelleStudioPort')}&uuid=${app.get('bluzelleStudioUUID')}`);
});
